...
@DisplayName("BSSNFT1")
@ManifestExtra(key = "author", value = "NeitGnud")
@SupportedStandard(neoStandard = NeoStandard.NEP_11)
public class NonFungibleTokenContract {

    static final Hash160 contractOwner = StringLiteralHelper.addressToScriptHash("NW1hkHc8Hpvz77n3DdXHTWV43SvBVzCcqf");
    ...
    public static boolean isContractOwner() {
    ...
    private static void throwIfSignerIsNotContractOwner() {
        assert Runtime.checkWitness(contractOwner) : "No authorization." + Runtime.getCallingScriptHash().toByteString().toString();
    }
